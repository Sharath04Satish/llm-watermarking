...
class WatermarkLogitsProcessor(WatermarkBase, LogitsProcessor):
    ...
    # Converting tensor arrays to numeric lists.
...
class WatermarkDetector(WatermarkBase):
    ...
    * z_threshold -> Changing this threshold will change the sensitivity of the detector.
    ...
    # Measure of how many standard deviations a data point is from the mean of a dataset.
    ...
    #  returns the probability that a random variable sampled from a standard normal distribution (mean = 0, standard deviation = 1) is greater than the z-score.
    ...
    def _score_ngrams_in_passage(self, input_ids: torch.Tensor):
        ...
        # Although self_salt is a bool value, 1 - True = 0, 1 - False = 1.
    ...
    def _score_sequence(
        ...
        if return_z_at_T:
            ...
            # Given a tensor, for example [1, 2, 3, 4], it will return an array [1, 3, 6, 10], the cummulative sum at each index.
...
# Given an array of tokenized text as integers, such as [1, 2, 3, 4, 5] with n = 4, it will create [(1, 2, 3, 4), (2, 3, 4, 5)] ngrams.
